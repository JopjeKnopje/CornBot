...
public class STATICS {
    ...
    public static final String TOKEN = "MjkxMzA1NjQwNzQyMjIzODcy.DVTqww.atuPR5JLUgqT6tLEoK5Yx-nbG9g";
    public static final String LOGCHANNEL = "voicelog"; // NOT CASE SENSITIVE!
    public static final String BOTCHANNEL = "bot-spam"; // NOT CASE SENSITIVE!
